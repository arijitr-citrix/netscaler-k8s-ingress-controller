...
1. Deploy the Netscaler ingress controller using the `kubectl create` command.
    ...
    The official Netscaler ingress controller docker image is available at: <span style="color:red"> `quay.io/netscaler/netscaler-k8s-ingress-controller:4.2.26` </span>
